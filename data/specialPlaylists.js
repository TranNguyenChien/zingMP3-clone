    ...
    playlists: [
      {
        ...
        image:
          "./assets/images/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist1.jpg",
      },
      {
        name: "Cớ Sao Em Buồn (Single)",
        artists: ["Nguyễn Trọng Tài"],
        image:
          "./assets/images/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist2.jpg",
      },
      {
        name: "Ngừng Mơ (Single)",
        artists: ["Nguyễn Trọng Tài"],
        image:
          "./assets/images/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist3.jpg",
      },
      {
        name: "Hongkong1 (Single)",
        artists: ["Nguyễn Trọng Tài"],
        image:
          "./assets/images/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist4.jpg",
      },
      {
        name: "Cớ Sao Em Buồn (Remixes EP)",
        artists: ["Nguyễn Trọng Tài"],
        image:
          "./assets/images/tabExplore/specialPlaylists/playlistSongs/playlistList1/playlist5.jpg",
      },
    ],
  },
  {
    ...
    playlists: [
      {
        ...
        image:
          "./assets/images/tabExplore/specialPlaylists/playlistSongs/playlistList2/playlist1.jpg",
      },
      {
        name: "Rap Việt Cũ Mà Hay",
        artists: ["Rhymastic", "LK", "Yanbi"],
        image:
          "./assets/images/tabExplore/specialPlaylists/playlistSongs/playlistList2/playlist2.jpg",
      },
      {
        name: "Rap Việt Cực Chất",
        artists: ["16 Typh", "Tage", "ICD"],
        image:
          "./assets/images/tabExplore/specialPlaylists/playlistSongs/playlistList2/playlist3.jpg",
      },
      {
        name: "Rap Việt Kết Hợp Cực Chất",
        artists: ["G5R Squad", "Phan Ann", "Tlinh"],
        image:
          "./assets/images/tabExplore/specialPlaylists/playlistSongs/playlistList2/playlist4.jpg",
      },
      {
  ...
  // Tab Radio
  {
    ...
    playlists: [
      ...
      },
      {
        ...
        artists: [],
        image:
          "/assets/images/tabRadio/specialPlaylists/playlistSongs/playlistList1/playlist5.jpg",
      },
    ],
  },
  {
    ...
    playlists: [
      ...
      },
      {
        ...
        artists: [],
        image:
          "/assets/images/tabRadio/specialPlaylists/playlistSongs/playlistList2/playlist3.jpg",
      },
      {
        name: "M.A.D",
        artists: [],
        image:
          "/assets/images/tabRadio/specialPlaylists/playlistSongs/playlistList2/playlist4.jpg",
      },
      {
        name: "Tóm Lại Là",
        artists: [],
        image:
          "/assets/images/tabRadio/specialPlaylists/playlistSongs/playlistList2/playlist5.jpg",
      },
    ],
  },
  {
    ...
    playlists: [
      {
        ...
        artists: [],
        image:
          "/assets/images/tabRadio/specialPlaylists/playlistSongs/playlistList3/playlist1.jpg",
      },
      {
        name: "Chạm x Sao",
        artists: [],
        image:
          "/assets/images/tabRadio/specialPlaylists/playlistSongs/playlistList3/playlist2.jpg",
      },
      {
        name: "Chạm x Bạn",
        artists: [],
        image:
          "/assets/images/tabRadio/specialPlaylists/playlistSongs/playlistList3/playlist3.jpg",
      },
    ],
  },
  // {
